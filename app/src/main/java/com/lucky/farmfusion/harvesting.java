...
public class harvesting extends AppCompatActivity {
    ...
    Button harvestOnBtn, harvestOffBtn, forwardHubBtn, backHubMotor;
...
//        addPressEffect(harvestOnBtn);
//        addPressEffect(harvestOffBtn);
...
//            sendData("HARVEST_ON");
//            Toast.makeText(this, "Harvest On", Toast.LENGTH_SHORT).show();
//        });
//
//        // ---------------------------------------------------------
...
//            sendData("HARVEST_OFF");
//            Toast.makeText(this, "Harvest off", Toast.LENGTH_SHORT).show();
//        });
//
//        // ---------------------------------------------------------
...
//            Intent i = new Intent(harvesting.this, MainActivity.class);
//            startActivity(i);
//            finish();
//        });
//
